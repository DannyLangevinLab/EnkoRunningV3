 ...
 */
public class RecyclerViewFragmentPartager extends Fragment {

    private RecyclerView mRecyclerView;
    private RecyclerView.Adapter mAdapter;


    public static RecyclerViewFragmentPartager newInstance() {
        return new RecyclerViewFragmentPartager();
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new RecyclerViewMaterialAdapter(new CardPartagerAdapter(mItems));
