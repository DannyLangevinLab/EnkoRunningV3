 ...
 */
public class InterfaceCourbes extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_interface_courbes);
    ...
    private class buttoncliquer implements Button.OnClickListener {
        ...
        public void onClick(View v) {
            if (v == retoursport) {
                Intent ouverture0 = new Intent(getApplicationContext(), MainActivity.class);
