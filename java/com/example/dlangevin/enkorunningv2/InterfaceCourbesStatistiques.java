 ...
 */
public class InterfaceCourbesStatistiques extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_interface_courbes_statistiques);
    ...
    private class buttoncliquer implements Button.OnClickListener {
        ...
        public void onClick(View v) {
            if (v == retoursport) {
                InterfaceCourbesStatistiques.this.finish();
                System.exit(0);
            }
            if (v== btn_drawer2){
