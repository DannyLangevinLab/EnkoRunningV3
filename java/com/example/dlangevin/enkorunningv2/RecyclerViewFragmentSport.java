 ...
 */
public class RecyclerViewFragmentSport extends Fragment {

    private RecyclerView mRecyclerView;
    private RecyclerView.Adapter mAdapter;


    public static RecyclerViewFragmentSport newInstance() {
        return new RecyclerViewFragmentSport();
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new RecyclerViewMaterialAdapter(new CardSportAdapter(mItems));
