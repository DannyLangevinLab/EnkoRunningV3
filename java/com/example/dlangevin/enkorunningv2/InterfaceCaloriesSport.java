 ...
 */
public class InterfaceCaloriesSport extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_interface_consocalories_sport);
    ...
    private class buttoncliquer implements Button.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (v == retoursport) {
                InterfaceCaloriesSport.this.finish();
                System.exit(0);
            }
            if (v== btn_drawer2){
