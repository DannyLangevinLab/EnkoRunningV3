 ...
 */
public class RecyclerViewFragmentStatistiques extends Fragment {

    private RecyclerView mRecyclerView;
    private RecyclerView.Adapter mAdapter;


    public static RecyclerViewFragmentStatistiques newInstance() {
        return new RecyclerViewFragmentStatistiques();
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new RecyclerViewMaterialAdapter(new CardStatistiquesAdapter(mItems));
